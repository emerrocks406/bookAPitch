...
insert into address(address_line_1, address_line_2, region, zipcode) values('5', 'test street', 'belfast', 'bt17kj') returning id into ADDRESS_ID;
...
insert into address(address_line_1, address_line_2, region, zipcode) values('4', 'test street', 'belfast', 'bt17kk') returning id into ADDRESS_ID;
insert into pitch_address(pitch_id,address_id) values(PITCH_ID, ADDRESS_ID);
...
insert into pitch(name) values('St.Emers') returning id into PITCH_ID;
insert into pitch_time_slot(status, pitch_id, time_slot_id) values('booked', PITCH_ID, TIME_SLOT_ID);
insert into address(address_line_1, address_line_2, region, zipcode) values('6', 'test street', 'belfast', 'bt17kw') returning id into ADDRESS_ID;
insert into pitch_address(pitch_id,address_id) values(PITCH_ID, ADDRESS_ID);
...
insert into pitch_time_slot(status, pitch_id, time_slot_id) values('available', PITCH_ID, TIME_SLOT_ID);
insert into address(address_line_1, address_line_2, region, zipcode) values('7', 'test park', 'belfast', 'bt119jk') returning id into ADDRESS_ID;
insert into pitch_address(pitch_id,address_id) values(PITCH_ID, ADDRESS_ID);
...
insert into pitch(name) values('Glenavy') returning id into PITCH_ID;
...
insert into address(address_line_1, address_line_2, region, zipcode) values('8', 'test close', 'belfast', 'bt171jq') returning id into ADDRESS_ID;
insert into pitch_address(pitch_id,address_id) values(PITCH_ID, ADDRESS_ID);
